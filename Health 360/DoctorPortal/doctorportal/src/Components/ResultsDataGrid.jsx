...
const VISIBLE_FIELDS = VISIBLE_FIELDS = ['username', 'firstname', 'lastname', 'typeofuser','age','region','gender','height','weight','disease'];

export default function ResultsDataGrid(props) {
  const {selectedUsers,setSelectedUsers, users} = props;
