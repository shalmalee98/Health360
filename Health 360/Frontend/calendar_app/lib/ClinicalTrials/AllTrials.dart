...
class AllTrials extends StatefulWidget {
  @override
  AllTrialsState createState() => AllTrialsState();
}

class AllTrialsState extends State<AllTrials> {
  ...
  Future<List<dynamic>> fetchData() async {
    ...
    final response = await http.get(Uri.parse(
        'https://midyear-castle-408217.uc.r.appspot.com/clinicaltrials/getAllapp/${userId}'));
